    ...
    <div class="ml_explorer">
        <div class="ml_files">
            <ul class="ml_tabs">
                ...
                <li><a href="#ml_audio">{{ __('Audio') }}</a></li>
                <li><a href="#ml_video">{{ __('Video') }}</a></li>
                <li><a href="#ml_docs">{{ __('Documents') }}</a></li>
            </ul>
            <ul class="ml_tab_content">
                ...
                <li id="ml_audio" class="tab_content audio">
                ...
                <li id="ml_video" class="tab_content video">
                ...
                <li id="ml_docs" class="tab_content documents">
        ...
        <div class="ml_sidebar">
            ...
            <div class="form_control delete-this">
                <form id="delete_file" method="POST">
                    @csrf
